...
// tar is CJS. This file is compiled to CommonJS (see tsconfig.json), so a
// bare require() is available directly — the createRequire(import.meta.url)
// dance the ESM build needed is neither necessary nor legal here.
